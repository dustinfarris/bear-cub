defmodule BearCubWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(BearCubWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(BearCubWeb.Gettext, "errors", msg, opts)
    # end
